              ...
              <div class="row">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body pt-0">
                      <div class="d-flex justify-content-between align-items-center mt-3 gap-3">
                        <h4 class="mb-0">Rp.<?php echo number_format($model->db_query($db, "SUM(amount) as total", "deposits")['rows']['total'],0,',','.') ?></h4>
                        <small class="text-danger">+<?php echo number_format($model->db_query($db, "*", "deposits")['count'],0,',','.') ?></small>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-xl-2 col-md-4 col-6 mb-4">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-center mt-3 gap-3">
                        <h4 class="mb-0">Rp.<?php echo number_format($model->db_query($db, "SUM(price) as total", "orders")['rows']['total'],0,',','.') ?></h4>
                        <small class="text-success"><?php echo number_format($model->db_query($db, "*", "orders")['count'],0,',','.') ?></small>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-xl-2 col-md-4 col-6 mb-4">
                  <div class="card">
                    <div class="card-body">
                      <h5 class="card-title mb-1 pt-2">Saldo User</h5>
                      <p class="mb-2 mt-1">Rp.<?php echo number_format($model->db_query($db, "SUM(balance) as total", "users")['rows']['total'],0,',','.') ?></p>
                      <div class="pt-1">
                        <span class="badge bg-label-secondary"><?php echo number_format($model->db_query($db, "*", "users")['count'],0,',','.') ?></span>
                      </div>
                    </div>
                  </div>
                </div>
