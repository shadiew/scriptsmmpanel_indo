                      ...
                      <div class="row gy-3">
                        <div class="col-md-3 col-6">
                          <div class="d-flex align-items-center">
                            ...
                            <div class="card-info">
                              <h5 class="mb-0"><?php echo number_format($model->db_query($db, "*", "orders WHERE user_id = '".$_SESSION['login']."'")['count'],0,',','.') ?></h5>
                              <small>Pesanan</small>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="card-body">
                      <ul class="p-0 m-0">
                        <li class="d-flex mb-4 pb-1">
                          <div class="me-3">
                            <img src="<?php echo $config['web']['base_url'] ?>/assets/img/products/iphone.png" alt="User" class="rounded" width="46" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="me-3">
                            <img
                              src="<?php echo $config['web']['base_url'] ?>/assets/img/products/nike-air-jordan.png"
                              alt="User"
                              class="rounded"
                              width="46" />
                          </div>
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="me-3">
                            <img src="<?php echo $config['web']['base_url'] ?>/assets/img/products/headphones.png" alt="User" class="rounded" width="46" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="me-3">
                            <img
                              src="<?php echo $config['web']['base_url'] ?>/assets/img/products/apple-watch.png"
                              alt="User"
                              class="rounded"
                              width="46" />
                          </div>
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="me-3">
                            <img
                              src="<?php echo $config['web']['base_url'] ?>/assets/img/products/amazon-echo.png"
                              alt="User"
                              class="rounded"
                              width="46" />
                          </div>
                        ...
                        <li class="d-flex">
                          <div class="me-3">
                            <img
                              src="<?php echo $config['web']['base_url'] ?>/assets/img/products/play-station.png"
                              alt="User"
                              class="rounded"
                              width="46" />
                          </div>
